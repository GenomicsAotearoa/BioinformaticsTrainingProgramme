...
<table>
  <tr>
    <td>
      <img src="training-affiliates/sara-burgess.jpeg" alt="Sara Burgess" style="width:200px; height:250px; object-fit:cover; border-radius:50%;">
    </td>
    <td style="padding-left:20px; text-align: justify;">
      <strong>Dr Sara Burgess, Massey University</strong><br>
      Dr Sara Burgess is a Research Officer with the School of Veterinary Science at Massey University with expertise in short and long whole genome sequencing and metagenomics. Her research focuses on understanding how antimicrobial resistant bacteria are transmitted between humans, animals and the environment. She also loves creating data visuals in R using publicly available datasets from around the world. 
      
      You can follow her work on [LinkedIn.](https://www.linkedin.com/in/sara-burgess-85b32045/)
 <br>
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td>
      <img src="training-affiliates/NatalieForsdick.JPG" alt="Natalie Forsdick" style="width:200px; height:250px; object-fit:cover; border-radius:50%;">
    </td>
    <td style="padding-left:20px; text-align: justify;">
      <strong>Dr Natalie Forsdick, Bioeconomy Science Institute</strong><br>
      Natalie is a conservation genomics researcher at the Bioeconomy Science Institute (formerly Manaaki Whenua - Landcare Research). She uses reference genome assembly and population genomic analysis to inform threatened species management for diverse including birds, plants, and insects. She has a keen interest in the impacts of hybridisation, and is an advocate for best practice data management.

    Contact Natalie at [forsdickn@landcareresearch.co.nz](mailto:forsdickn@landcareresearch.co.nz)
