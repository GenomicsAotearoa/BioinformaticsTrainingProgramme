...
- [Introduction to Shell for bioinformatics](portfolio.qmd#intro-shell) (23.09.2026). [*Registrations open*](https://www.eventbrite.co.nz/e/introduction-to-shell-for-bioinformatics-tickets-1999731834749?aff=oddtdtcreator)  

**October 2026**  

- [Introduction to R for bioinformatics](portfolio.qmd#intro-r) (08.10.2026). *Registrations opening late September.*   


**Other workshops**

*See the [National Training Calendar](https://www.reannz.co.nz/products-and-services/training-and-consultancy/training/training-calendar) maintained by REANNZ for more training opportunities*
:::


::: {.callout-note}
# UPCOMING GA SPONSORED EVENTS

**MapNet NZ 2026**  
*3rd Nov - 5th Nov*  
LIC, Hamilton    
[***Registrations and abstract submissions now open***](https://nzmapnet.github.io/)  
*Student travel grants available, see Register tab to apply.*  
[![](mapnet26.PNG){width=60%}](https://nzmapnet.github.io/)  

---


**Summer Institute in Statistical Genomics**   
*23rd Nov - 4th Dec*  
Waipapa Taumata Rau – University of Auckland City Campus  
[***Registrations now open***](https://events.humanitix.com/southern-ssig-auckland-2026)   
*Student scholarships available, see registration link to apply.* 
[![](sisg2026.PNG){width=60%}](https://events.humanitix.com/southern-ssig-auckland-2026) 
...
Since its inception in 2019, Genomics Aotearoa's training programme has hosted more than 130 workshops reaching more than 2,600 participants.
...
All you will need to complete the workshop is a computer with an internet connection and a web browser. All workshop material, which includes written notes that cover all main points, code examples, and tasks (as well as their solutions), is provided in advance and is freely available - visit our [Workshop Portfolio](portfolio.qmd) page.

Workshops are either in person or online (zoom), and are typically run across one or two days. See workshop portfolio for individual workshop scheduling times.  

All workshops are run under The Carpentries [Code of Conduct](https://docs.carpentries.org/topic_folders/policies/code-of-conduct.html) to promote a safe and inclusive working environment.  To encourage interactive learner participation, we do not record workshops and generally do not allow the use of external recording tools, including AI tools, during workshops. We are committed to accessibility and ask that learners who need additional tools to fully participate to contact the workshop organisers prior to the workshop day, so that suitable arrangements can be made.  
...
- Reproducibility with Git and Quarto (15-16.09.2026)  
- Introduction to R for bioinformatics (1-2.09.2026)  


**August**    

- Constructing Pangenome Graphs (26.08.2026)      
- Introduction to bash scripting/HPC job scheduler (20.08.2026)     
- Mini series: GOseq for non-models (12.08.2026)  
- Intermediate Shell for Bioinformatics (6.08.2026)  
 
 
**July**  

- Visualisation with ggplot2 (22.07.2026).  
- Intermediate R for bioinformatics (8-9.07.2026).     


**June** 

- Introduction to R (10-11.06.2026).     
- Introduction to Shell for Bioinformatics (3-4.06.2026).   


**May**  

- Reproducible Bioinformatics with Nextflow and nf-core (20.05.2026).  
- Reproducibility with Git and Quarto (13-14.05.2026)  

**April**   

- Introduction to Bash scripting and HPC job scheduling (23.04.2026)  

**March**   

- RNA-seq Data Analysis (25-26.03.2026)  
- Visualisation with ggplot2 (11.03.2026)   

**February**  

- Introduction to R (25.02.2026)  
- Introduction to shell (18.02.2026)  
...
- Otago Bioinformatics Spring School (17-21.11.2025)    

**October**  

- Reproducibility with Git and Quarto (23-24.10.2025)     
- Introduction to R (15.10.2025)  

**September** 

- RNAseq Data Analysis (17-18.09.2025)  
- Visualisation with ggplot2 (11.09.2025)  
- Introduction to R (10.09.2025)  
